...
jQuery(window).on("load", function () {
  ...
  (function (e) {
    ...
    for (
      ...
      n = n.parent().addClass("mm-show").parent().addClass("mm-active");
    e("ul#menu>li").on("click", function () {
      "mini" === e("body").attr("data-sidebar-style") &&
        (console.log(e(this).find("ul")), e(this).find("ul").stop());
    });
    var a = window.outerHeight;
    ((a = window.outerHeight) > 0 ? a : screen.height) &&
      e(".content-body").css("min-height", a + 60 + "px"),
      e('a[data-action="collapse"]').on("click", function (t) {
        t.preventDefault(),
          ...
          e(this).closest(".card").children(".card-body").collapse("toggle");
      }),
      e('a[data-action="expand"]').on("click", function (t) {
        t.preventDefault(),
          ...
          e(this).closest(".card").toggleClass("card-fullscreen");
      }),
    ...
    const c = e(".header").innerHeight();
    e(window).scroll(function () {
      "horizontal" === e("body").attr("data-layout") &&
        "static" === e("body").attr("data-header-position") &&
        "fixed" === e("body").attr("data-sidebar-position") &&
        (e(this.window).scrollTop() >= c
    ...
    e(".btn-number").on("click", function (t) {
      ...
      e(".dz-load-more").on("click", function (t) {
        ...
        e.ajax({
          ...
          dataType: "html",
          success: function (t) {
            e("#" + a + "Content").append(t), e(".dz-load-more i").remove();
          },
        });
      }),
